...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -std=c++11   -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector
