...
!define URL http://www.twincoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/twincoin.ico"
...
OutFile twincoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/twincoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/nevacoind.exe
