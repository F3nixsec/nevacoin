...
static const int64_t MAX_MONEY = 101000000 * COIN;
...
inline bool IsProtocolV3(int nHeight) { return TestNet() || nHeight > 2; } //revert back to old difficulty setting, staking problem
inline bool IsProtocolV4(int nHeight) { return TestNet() || nHeight > 3; } //  hard fork, future drift adjustments
...
inline unsigned int GetTargetSpacing(int nHeight) {return (nHeight > 4) ? 60 : 60; }  // increase block target at block height 15000
